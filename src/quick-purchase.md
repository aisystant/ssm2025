...
products:
  ...
  -
    title: 'Серия семинаров FPF + DPF'
    items:
      -
        name: 'Вся серия FPF + DPF (5 семинаров)'
        text: '2026-07-12'
        price: '60&nbsp;000&nbsp;₽'
        info:
          name: 'Подробнее'
      ...
      -
        ...
        info:
          ...
          path: 'fpf4'
      -
        name: 'FPF-5. Свой DPF: как дать AI-агенту правила вашей работы'
        text: '2026-08-09'
        price: '14&nbsp;000&nbsp;₽'
        info:
          name: 'Подробнее'
          path: 'fpf5'
    text:
      - '5 практикумов с <a href="/team/levenchuk">Анатолием Левенчуком</a> о&nbsp;том, как использовать FPF и DPF для&nbsp;работы с&nbsp;AI-агентами: от&nbsp;минимальной FPF-грамотности до&nbsp;предметных регламентов под&nbsp;свою работу.'
