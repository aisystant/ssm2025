...
<div class="iwe-inner">
  ...
  <div class="iwe-phil-grid">
    <div class="iwe-phil-card">
      ...
      <h3>Тамагочи</h3>
      <p>Выращиваемый питомец, который требует ухода. Забросишь — деградирует. Вкладываешь — растёт. Две роли: формируешь и пользуешься. Одно без другого не работает.</p>
    </div>
    <div class="iwe-phil-card">
      <div class="iwe-phil-icon">🌐</div>
      <h3>Аватар в сети</h3>
