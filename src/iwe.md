...
<div class="iwe-steps-hint">Дальше — спроси бота: <b>«Что мне ещё нужно подключить для полного IWE?»</b> Бот проверит текущий уровень доступа и покажет следующий шаг: ЦД и GitHub подключаются в <code>/settings</code> → Подключения.</div>
</details>
