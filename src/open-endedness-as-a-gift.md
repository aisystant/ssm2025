---
title: Купить подписку "Инженерия интеллекта" в подарок
description: 'Подарите подписку "Инженерия интеллекта" на онлайн-курсы Мастерской инженеров-менеджеров своим коллегам, друзьям или близким. Инструкция по покупке подарочной подписки.'
class: text-content
---
...
Подписка начинает действовать с момента оплаты и на нее распространяются все условия подписки ["Инженерия интеллекта"](/open-endedness).
