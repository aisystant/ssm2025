...
swiper1:
  ...
  slides:
    -
      ...
      link: '/stack'
    -
      head: 'Современное фундаментальное знание, основанное на&nbsp;связи научно-технических и гуманитарных знаний'
      image: 'slide2.jpg'
...
education:
  ...
  items:
    -
      button: 'Самостоятельная работа'
      link: '/open-endedness'
      text: 'Можно полистать руководства бесплатно после регистрации'
      image: 'self-study.svg'
    -
      button: 'Групповая работа'
      link: '/list'
      text: 'Узнать расписание резидентур и практикумов с&nbsp;наставником'
...
swiper2:
  ...
  slides:
    -
      head: 'Для новичков'
      title: 'С чего начать?'
      text: 'Пройдите через процесс знакомства с нашей программой'
      image: 'slide5.jpg'
      link: '/howtostart'
    -
      head: 'Для всех'
      title: 'Программа «Личное развитие»'
      text: 'Программа для тех, кто хочет вернуть себе умение развивать сложные навыки, поставить под контроль своё внимание и тело, упорядочить свою жизнь'
      image: 'slide6.jpg'
      link: '/programs/intro'
    -
    ...
    -
      head: 'Для команд'
      title: 'Развитие команд топ-менеджеров'
    ...
    -
      head: 'Для всех'
      title: 'Подписка на онлайн-руководства «Инженерия интеллекта»'
