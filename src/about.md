...
internships:
    title:
      - 'У нас не курсы.'
      - 'У нас резидентуры, практикумы, семинары и руководства.'
    items:
      -
...
features:
    title: 'Особенности нашего подхода'
    items:
      -
      ...
      -
        name: 'Наши выпускники умеют передавать знания'
      ...
      -
        name: 'Работа на собственных кейсах'
        text: 'Никаких «учебных проектов», все проекты из вашей практики'
      -
        name: 'Разные форматы работы'
        text: 'Самостоятельно с помощью нашего AI-помощника Aisystant, с поддержкой наставника, корпоративные и вузовские группы'
      -
...
contacts:
    ...
    footer: 'До встречи на резидентурах, практикумах, семинарах и&nbsp;разборах!'
---
