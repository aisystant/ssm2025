...
content:
    ...
    courses:
      -
        name: 'Распожаризация: как не «тушить пожары» на&nbsp;работе, а&nbsp;избегать их появления – 6&nbsp;недель'
        path: '1-org-dev'
      -
        name: 'Моделирование как основа коммуникации и лидерства – 6&nbsp;недель'
        path: '2-org-dev'
      -
        name: 'Рабочее моделирование в инженерии и менеджменте – 6&nbsp;недель'
        path: '3-org-dev'
      -
        name: 'Причинность, интервенции и контрфактичность в инженерии и менеджменте – 6&nbsp;недель'
        path: '4-org-dev'
      -
        name: 'Системное мышление – 6&nbsp;недель'
        path: '5-org-dev'
      -
        name: 'Системное моделирование – 6&nbsp;недель'
        path: '6-org-dev'
      -
        name: 'Методология – 6&nbsp;недель'
        path: '7-org-dev'
      -
        name: 'Системная инженерия – 6&nbsp;недель'
        path: '8-org-dev'
      -
        name: 'Инженерия мастерства – 6&nbsp;недель'
        path: '9-org-dev'
      -
        name: 'Системный менеджмент – 6&nbsp;недель'
        path: '10-org-dev'
...
prerequisites:
    title: 'Пререквизиты'
    items:
      - 'На первую резидентуру программы <b>«Распожаризация»</b> принимаются все, кто окончил школу и участвует в действующем рабочем проекте (в любой роли).'
