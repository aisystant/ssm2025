...
education:
    -
      ...
      description: 'Подходит, если хочешь попробовать или есть свой отработанных метод длительной поддержки внимания на&nbsp;работе новыми методами.'
...
prerequisites:
    title: 'Пререквизиты'
    items:
      - 'Завершённая в любом формате программа <b>«Рабочее развитие»</b>.'
      ...
      - 'Параллельное прохождение иных программ не рекомендуем.'
...
training:
    ...
    items:
      -
        ...
        text: 'Изучаешь текстовое руководство в течение недели, разрабатываешь или улучшаешь свою модель рабочего проекта (можно, нескольких) и обсуждаешь изменения на общем разборе с наставником раз в неделю. Наставник и другие участники комментируют модели, посты в клубе и отвечают на вопросы в чате Телеграм. Для обучения с наставником нужно записаться в группу с наставником.'
      -
