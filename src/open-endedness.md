...
components:
  ...
  items:
    ...
    -
      icon: 'calendar'
      text: 'Трекер учёта времени, инвестированного в работу с руководствами'
    -
      icon: 'notepad'
    ...
    -
      icon: 'chart'
      text: 'Прогноз времени до завершения работы с руководством'
    -
      icon: 'userlist'
      text: 'Автоматическая проверка заданий + авторские ответы'
    -
      icon: 'filesearch'
      text: 'Полнотекстовый поиск по руководствам'
    -
      icon: 'stack'
